...
//     try {
//       const response = await axios.get(
//         `https://lrs-final-back-1.onrender.com/landRoute/transfer-statuses/${userId}`
//       );
...
//     try {
//       // First check if payment is in escrow
...
//           (transaction.status === 'inEscrow' || transaction.status === 'pending')) {
//         alert("Cannot request transfer while payment is in escrow. Please wait for the payment to be released.");
//         return;
//       }
...
//         'https://lrs-final-back-1.onrender.com/landRoute/request-transfer',
//         transferData,
//         {
//           headers: {
...
//     } catch (error) {
//       console.error("Error requesting transfer:", error);
//       alert(error.response?.data?.message || "Failed to request transfer. Please try again.");
//     }
//   };
